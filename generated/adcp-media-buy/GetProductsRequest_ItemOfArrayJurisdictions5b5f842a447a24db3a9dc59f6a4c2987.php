...
/**
 * Class GetProductsRequest_ItemOfArrayJurisdictions5b5f842a447a24db3a9dc59f6a4c2987
...
class GetProductsRequest_ItemOfArrayJurisdictions5b5f842a447a24db3a9dc59f6a4c2987 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
  ...
  4 => 'render_guidance',
    ...
    /**
     * GetProductsRequest_ItemOfArrayJurisdictions5b5f842a447a24db3a9dc59f6a4c2987 constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsRequest_ItemOfArrayJurisdictions5b5f842a447a24db3a9dc59f6a4c2987',
)));
}
...
if ((!is_string($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'string',
                 ...
                 *
                 * @return GetProductsRequest_Render_Guidance3467823fe3b66b8963ab5f5c1c32f6bf|null
                 */
                public function getRenderGuidance(): ?GetProductsRequest_Render_Guidance3467823fe3b66b8963ab5f5c1c32f6bf
                {
                 ...
                 *
                 * @param GetProductsRequest_Render_Guidance3467823fe3b66b8963ab5f5c1c32f6bf $renderGuidance How the disclosure should be rendered for this jurisdiction. Expresses the declaring party's intent for persistence and position based on regulatory requirements. Publishers control actual rendering but governance agents can audit whether guidance was followed.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setRenderGuidance(
                    GetProductsRequest_Render_Guidance3467823fe3b66b8963ab5f5c1c32f6bf $renderGuidance
                ): static {
    ...
    try {
        return is_array($value) ? new GetProductsRequest_Render_Guidance3467823fe3b66b8963ab5f5c1c32f6bf($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_Render_Guidance3467823fe3b66b8963ab5f5c1c32f6bf)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'render_guidance',
  1 => 'GetProductsRequest_Render_Guidance3467823fe3b66b8963ab5f5c1c32f6bf',
)));
}
