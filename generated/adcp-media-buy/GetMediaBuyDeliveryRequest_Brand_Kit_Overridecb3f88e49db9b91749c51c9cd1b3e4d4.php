...
/**
 * Class GetMediaBuyDeliveryRequest_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4
...
class GetMediaBuyDeliveryRequest_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo')]
        
            #[SchemaName('logo')]
        
        /** @var GetMediaBuyDeliveryRequest_ImageAsset|null Override logo asset. */
        protected $logo;
    
        
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/colors')]
        
            #[SchemaName('colors')]
        
        /** @var GetMediaBuyDeliveryRequest_Colors58142eaea10c7af98af1bebfac793b60|null Override brand colors (hex strings). */
        protected $colors;
    
        
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/voice')]
        ...
        protected $voice;
            ...
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/tagline')]
  ...
  3 => 'tagline',
    ...
    /**
     * GetMediaBuyDeliveryRequest_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4 constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetMediaBuyDeliveryRequest_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4',
)));
}
    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
                 ...
                 * Override logo asset.
                 *
                 * @return GetMediaBuyDeliveryRequest_ImageAsset|null
                 */
                public function getLogo(): ?GetMediaBuyDeliveryRequest_ImageAsset
                {
                 ...
                 *
                 * @param GetMediaBuyDeliveryRequest_ImageAsset $logo Override logo asset.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setLogo(
                    GetMediaBuyDeliveryRequest_ImageAsset $logo
                ): static {
                    if ($this->logo === $logo) {
                        return $this;
                    }
    ...
    try {
        return is_array($value) ? new GetMediaBuyDeliveryRequest_ImageAsset($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuyDeliveryRequest_ImageAsset)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'logo',
  1 => 'GetMediaBuyDeliveryRequest_ImageAsset',
)));
}
                 ...
                 *
                 * @return GetMediaBuyDeliveryRequest_Colors58142eaea10c7af98af1bebfac793b60|null
                 */
                public function getColors(): ?GetMediaBuyDeliveryRequest_Colors58142eaea10c7af98af1bebfac793b60
                {
                 ...
                 *
                 * @param GetMediaBuyDeliveryRequest_Colors58142eaea10c7af98af1bebfac793b60 $colors Override brand colors (hex strings).
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setColors(
                    GetMediaBuyDeliveryRequest_Colors58142eaea10c7af98af1bebfac793b60 $colors
                ): static {
            ...
            protected function processColors(array $modelData): void
            {
                ...
                $value = (function ($value) {
    try {
        return is_array($value) ? new GetMediaBuyDeliveryRequest_Colors58142eaea10c7af98af1bebfac793b60($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuyDeliveryRequest_Colors58142eaea10c7af98af1bebfac793b60)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'colors',
  1 => 'GetMediaBuyDeliveryRequest_Colors58142eaea10c7af98af1bebfac793b60',
)));
}
