...
/**
 * Class GetMediaBuyDeliveryRequest_ImageAsset
...
class GetMediaBuyDeliveryRequest_ImageAsset implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/asset_type')]
        ...
        protected $assetType;
            ...
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/url')]
        ...
        protected $url;
            ...
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/width')]
        ...
        protected $width;
            ...
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/height')]
        ...
        protected $height;
            ...
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/format')]
        ...
        protected $format;
            ...
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/alt_text')]
        ...
        /** @var GetMediaBuyDeliveryRequest_Provenance|null Provenance metadata for this asset, overrides manifest-level provenance */
  ...
  6 => 'provenance',
    ...
    /**
     * GetMediaBuyDeliveryRequest_ImageAsset constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetMediaBuyDeliveryRequest_ImageAsset',
)));
}
...
if ((!is_string($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'string',
                 ...
                 *
                 * @return GetMediaBuyDeliveryRequest_Provenance|null
                 */
                public function getProvenance(): ?GetMediaBuyDeliveryRequest_Provenance
                {
                 ...
                 *
                 * @param GetMediaBuyDeliveryRequest_Provenance $provenance Provenance metadata for this asset, overrides manifest-level provenance
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setProvenance(
                    GetMediaBuyDeliveryRequest_Provenance $provenance
                ): static {
    ...
    try {
        return is_array($value) ? new GetMediaBuyDeliveryRequest_Provenance($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuyDeliveryRequest_Provenance)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'provenance',
  1 => 'GetMediaBuyDeliveryRequest_Provenance',
)));
}
