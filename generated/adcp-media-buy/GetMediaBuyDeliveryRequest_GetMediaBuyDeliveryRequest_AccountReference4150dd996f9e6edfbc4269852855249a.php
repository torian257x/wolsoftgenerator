...
/**
 * Class GetMediaBuyDeliveryRequest_GetMediaBuyDeliveryRequest_AccountReference4150dd996f9e6edfbc4269852855249a
...
class GetMediaBuyDeliveryRequest_GetMediaBuyDeliveryRequest_AccountReference4150dd996f9e6edfbc4269852855249a implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;
        ...
        /** @var GetMediaBuyDeliveryRequest_BrandReference Brand reference identifying the advertiser */
        protected $brand;
    ...
    /**
     * GetMediaBuyDeliveryRequest_GetMediaBuyDeliveryRequest_AccountReference4150dd996f9e6edfbc4269852855249a constructor.
     *
...
if ($additionalProperties =  (static function () use ($modelData): array {
  ...
  0 => 'GetMediaBuyDeliveryRequest_GetMediaBuyDeliveryRequest_AccountReference4150dd996f9e6edfbc4269852855249a',
  1 => $additionalProperties,
    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
                 ...
                 *
                 * @return GetMediaBuyDeliveryRequest_BrandReference
                 */
                 ...
                 *
                 * @param GetMediaBuyDeliveryRequest_BrandReference $brand Brand reference identifying the advertiser
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuyDeliveryRequest_BrandReference)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'brand',
  1 => 'GetMediaBuyDeliveryRequest_BrandReference',
)));
}
