...
/**
 * Class GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078
...
class GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/brand/properties/data_subject_contestation/properties/url')]
        ...
        protected $url;
            ...
            #[JsonPointer('/properties/brand/properties/data_subject_contestation/properties/email')]
        ...
        protected $email;
            ...
            #[JsonPointer('/properties/brand/properties/data_subject_contestation/properties/languages')]
  ...
  2 => 'languages',
    ...
    /**
     * GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078 constructor.
     *
...
if ($additionalProperties =  (static function () use ($modelData): array {
  ...
  0 => 'GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078',
...
(function (&$value) use (
    ...
    try {
        return is_array($value) ? new GetProductsRequest_GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca0788e14c97c9beaed8b96c9902df29ab5cb($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca0788e14c97c9beaed8b96c9902df29ab5cb)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078',
  1 => 'GetProductsRequest_GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca0788e14c97c9beaed8b96c9902df29ab5cb',
)));
}
                ...
                if (is_object($value) && is_array($originalModelData)) {
                    $modifiedValues = array_merge($modifiedValues, $this->_getModifiedValues_6e7c1($originalModelData, $value));
                }
        ...
        try {
                ...
                $value = (function ($value) {
    try {
        return is_array($value) ? new GetProductsRequest_GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078e1890aaf821322237928d62a94d5f101($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078e1890aaf821322237928d62a94d5f101)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078',
  1 => 'GetProductsRequest_GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078e1890aaf821322237928d62a94d5f101',
)));
}
...
if ((!is_string($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => $invalidItems_48c48fb0dab81726d73986a71c0eb336,
                        ...
                        private function _getModifiedValues_6e7c1(array $originalModelData, object $nestedCompositionObject): array {
                            $modifiedValues = [];
