...
/**
 * Class GetMediaBuysResponse_BrandReference
...
class GetMediaBuysResponse_BrandReference implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/media_buys/items/properties/account/properties/brand/properties/domain')]
        ...
        protected $domain;
            ...
            #[JsonPointer('/properties/media_buys/items/properties/account/properties/brand/properties/brand_id')]
        ...
        protected $brandId;
            ...
            #[JsonPointer('/properties/media_buys/items/properties/account/properties/brand/properties/industries')]
...
**Merge semantics (normative).** The merge is **field-level**, not whole-object replacement. Each field within `brand_kit_override` (`logo`, `colors`, `voice`, `tagline`) is evaluated independently — when a field is present on the override the override value applies; when a field is absent the brand.json value applies (or is absent if brand.json doesn't carry one either). For composite fields (`colors.primary`, `colors.secondary`, `colors.accent`), the merge is one level deeper: each color slot is evaluated independently — a producer can override `colors.primary` while still inheriting `colors.secondary` from brand.json. SDKs MUST NOT treat a present `brand_kit_override.colors` as wiping the brand.json `colors` block entirely; only the per-slot fields present in the override take precedence. Without this rule, a partial-override semantics would diverge across SDKs and produce inconsistent rendering for the same payload. */
  ...
  4 => 'brand_kit_override',
    ...
    /**
     * GetMediaBuysResponse_BrandReference constructor.
     *
...
if ($additionalProperties =  (static function () use ($modelData): array {
  ...
  0 => 'GetMediaBuysResponse_BrandReference',
...
if ((!is_array($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'array',
                 ...
                 *
                 * @return GetMediaBuysResponse_Data_Subject_Contestation6ce85a378238546858b122363ebca078|null
                 */
                public function getDataSubjectContestation(): ?GetMediaBuysResponse_Data_Subject_Contestation6ce85a378238546858b122363ebca078
                {
                 ...
                 *
                 * @param GetMediaBuysResponse_Data_Subject_Contestation6ce85a378238546858b122363ebca078 $dataSubjectContestation Inline override for the brand's contestation contact point. Useful when the operator does not control brand.json but needs to discharge Art 22(3) for this plan. brand.json is canonical; when omitted, governance agents resolve brand → house → missing.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setDataSubjectContestation(
                    GetMediaBuysResponse_Data_Subject_Contestation6ce85a378238546858b122363ebca078 $dataSubjectContestation
                ): static {
    ...
    try {
        return is_array($value) ? new GetMediaBuysResponse_Data_Subject_Contestation6ce85a378238546858b122363ebca078($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuysResponse_Data_Subject_Contestation6ce85a378238546858b122363ebca078)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'data_subject_contestation',
  1 => 'GetMediaBuysResponse_Data_Subject_Contestation6ce85a378238546858b122363ebca078',
)));
}
...
**Merge semantics (normative).** The merge is **field-level**, not whole-object replacement. Each field within `brand_kit_override` (`logo`, `colors`, `voice`, `tagline`) is evaluated independently — when a field is present on the override the override value applies; when a field is absent the brand.json value applies (or is absent if brand.json doesn't carry one either). For composite fields (`colors.primary`, `colors.secondary`, `colors.accent`), the merge is one level deeper: each color slot is evaluated independently — a producer can override `colors.primary` while still inheriting `colors.secondary` from brand.json. SDKs MUST NOT treat a present `brand_kit_override.colors` as wiping the brand.json `colors` block entirely; only the per-slot fields present in the override take precedence. Without this rule, a partial-override semantics would diverge across SDKs and produce inconsistent rendering for the same payload.
                 *
                 * @return GetMediaBuysResponse_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4|null
                 */
                public function getBrandKitOverride(): ?GetMediaBuysResponse_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4
                {
...
**Merge semantics (normative).** The merge is **field-level**, not whole-object replacement. Each field within `brand_kit_override` (`logo`, `colors`, `voice`, `tagline`) is evaluated independently — when a field is present on the override the override value applies; when a field is absent the brand.json value applies (or is absent if brand.json doesn't carry one either). For composite fields (`colors.primary`, `colors.secondary`, `colors.accent`), the merge is one level deeper: each color slot is evaluated independently — a producer can override `colors.primary` while still inheriting `colors.secondary` from brand.json. SDKs MUST NOT treat a present `brand_kit_override.colors` as wiping the brand.json `colors` block entirely; only the per-slot fields present in the override take precedence. Without this rule, a partial-override semantics would diverge across SDKs and produce inconsistent rendering for the same payload.
                ...
                public function setBrandKitOverride(
                    GetMediaBuysResponse_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4 $brandKitOverride
                ): static {
            ...
            protected function processBrandKitOverride(array $modelData): void
            {
                ...
                $value = (function ($value) {
    try {
        return is_array($value) ? new GetMediaBuysResponse_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuysResponse_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'brand_kit_override',
  1 => 'GetMediaBuysResponse_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4',
)));
}
