...
/**
 * Class GetMediaBuyDeliveryRequest_Duration
...
class GetMediaBuyDeliveryRequest_Duration implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;
        ...
        /** @var GetMediaBuyDeliveryRequest_DurationUnit Time unit. 'seconds' for sub-minute precision. 'campaign' spans the full campaign flight. */
        protected $unit;
    ...
    /**
     * GetMediaBuyDeliveryRequest_Duration constructor.
     *
...
if ($additionalProperties =  (static function () use ($modelData): array {
  ...
  0 => 'GetMediaBuyDeliveryRequest_Duration',
...
if (is_int($value) && $value < 1) {
  ...
  1 => 1,
                 ...
                 *
                 * @return GetMediaBuyDeliveryRequest_DurationUnit
                 */
                public function getUnit(): GetMediaBuyDeliveryRequest_DurationUnit
                {
                 ...
                 *
                 * @param string|GetMediaBuyDeliveryRequest_DurationUnit $unit Time unit. 'seconds' for sub-minute precision. 'campaign' spans the full campaign flight.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setUnit(
                    string | GetMediaBuyDeliveryRequest_DurationUnit $unit
                ): static {
                    if ($this->unit === $unit) {
                        return $this;
                    }
...
if ($value instanceof UnitEnum && !($value instanceof GetMediaBuyDeliveryRequest_DurationUnit)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Generic\InvalidTypeException($value ?? null, ...array (
  0 => 'unit',
  1 => 'GetMediaBuyDeliveryRequest_DurationUnit',
)));
}
...
(
  ...
  'fqcn' => 'AdCP\\MediaBuy\\Enums\\GetMediaBuyDeliveryRequest_DurationUnit',
));
