...
/**
 * Builder class for GetProductsRequest_BrandReference
 */
class GetProductsRequest_BrandReferenceBuilder implements BuilderInterface
{
    /** @var array */
    ...
    /**
     * Set up a new instance of GetProductsRequest_BrandReference with fully validated properties
     */
    public function validate(): GetProductsRequest_BrandReference
    {
        ...
        return new GetProductsRequest_BrandReference($this->_rawModelDataInput);
    }
    ...
    private function _array_walk_recursive_real(array &$array, callable $callback): void
    {
        foreach ($array as &$value) {
             ...
             *
             * {@link GetProductsRequest_BrandReference::processDomain}
             * 
             *
             * @return static
             */
             ...
             *
             * {@link GetProductsRequest_BrandReference::processBrandId}
             * 
             *
             * @return static
             */
             ...
             *
             * {@link GetProductsRequest_BrandReference::processIndustries}
             * 
             *
             * @return static
             */
             ...
             *
             * @return GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078|GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078Builder|array|null
             */
             ...
             *
             * @param GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078|GetProductsRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078Builder|array $dataSubjectContestation Inline override for the brand's contestation contact point. Useful when the operator does not control brand.json but needs to discharge Art 22(3) for this plan. brand.json is canonical; when omitted, governance agents resolve brand → house → missing.
             *
             * {@link GetProductsRequest_BrandReference::processDataSubjectContestation}
             * 
             *
             * @return static
             */
...
**Merge semantics (normative).** The merge is **field-level**, not whole-object replacement. Each field within `brand_kit_override` (`logo`, `colors`, `voice`, `tagline`) is evaluated independently — when a field is present on the override the override value applies; when a field is absent the brand.json value applies (or is absent if brand.json doesn't carry one either). For composite fields (`colors.primary`, `colors.secondary`, `colors.accent`), the merge is one level deeper: each color slot is evaluated independently — a producer can override `colors.primary` while still inheriting `colors.secondary` from brand.json. SDKs MUST NOT treat a present `brand_kit_override.colors` as wiping the brand.json `colors` block entirely; only the per-slot fields present in the override take precedence. Without this rule, a partial-override semantics would diverge across SDKs and produce inconsistent rendering for the same payload.
             *
             * @return GetProductsRequest_Brand_Kit_Overridef12307c60b9bcadd7ce1979c762e24c6|GetProductsRequest_Brand_Kit_Overridef12307c60b9bcadd7ce1979c762e24c6Builder|array|null
             */
