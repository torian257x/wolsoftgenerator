...
/**
 * Class GetMediaBuysResponse_ItemOfArrayWatermarks254d53f57a5c6e0b76076f9e8940ee56
...
#[JsonPointer('/properties/media_buys/items/properties/account/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/watermarks/items')]

class GetMediaBuysResponse_ItemOfArrayWatermarks254d53f57a5c6e0b76076f9e8940ee56 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/media_buys/items/properties/account/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/watermarks/items/properties/media_type')]
        ...
        protected $mediaType;
            ...
            #[JsonPointer('/properties/media_buys/items/properties/account/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/watermarks/items/properties/provider')]
        ...
        protected $c2paAction;
            ...
            #[JsonPointer('/properties/media_buys/items/properties/account/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/watermarks/items/properties/embedded_at')]
  ...
  4 => 'embedded_at',
    ...
    /**
     * GetMediaBuysResponse_ItemOfArrayWatermarks254d53f57a5c6e0b76076f9e8940ee56 constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetMediaBuysResponse_ItemOfArrayWatermarks254d53f57a5c6e0b76076f9e8940ee56',
)));
}
...
if ((!is_string($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'string',
                 ...
                 *
                 * @return GetMediaBuysResponse_Verify_Agentbcc150a81b5d33f22392dcef014818e1|null
                 */
                public function getVerifyAgent(): ?GetMediaBuysResponse_Verify_Agentbcc150a81b5d33f22392dcef014818e1
                {
                 ...
                 *
                 * @param GetMediaBuysResponse_Verify_Agentbcc150a81b5d33f22392dcef014818e1 $verifyAgent Buyer's representation that this watermark can be detected by a governance agent on the seller's `creative_policy.accepted_verifiers` list. The `agent_url` MUST match (canonicalized) one of the seller's published `accepted_verifiers[].agent_url` entries; sellers reject `sync_creatives` submissions whose `verify_agent.agent_url` is off-list with `PROVENANCE_VERIFIER_NOT_ACCEPTED`. This is buyer-supplied evidence, not buyer-driven routing — the seller is the verifier-of-record and the seller controls which agent it actually calls (the seller MAY use a different on-list agent if it determines this is more appropriate; the seller does not call buyer-asserted endpoints outside its allowlist).
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setVerifyAgent(
                    GetMediaBuysResponse_Verify_Agentbcc150a81b5d33f22392dcef014818e1 $verifyAgent
                ): static {
    ...
    try {
        return is_array($value) ? new GetMediaBuysResponse_Verify_Agentbcc150a81b5d33f22392dcef014818e1($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuysResponse_Verify_Agentbcc150a81b5d33f22392dcef014818e1)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'verify_agent',
  1 => 'GetMediaBuysResponse_Verify_Agentbcc150a81b5d33f22392dcef014818e1',
)));
}
