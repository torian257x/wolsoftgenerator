...
/**
 * Class GetMediaBuysResponse_ItemOfArrayGeo_Postal_Areas_Excludeb3b0176fce8ade5a14c48dbec850724e
...
#[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/geo_postal_areas_exclude/items')]

class GetMediaBuysResponse_ItemOfArrayGeo_Postal_Areas_Excludeb3b0176fce8ade5a14c48dbec850724e implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/$defs/PostalCodeSystem')]
        
            #[SchemaName('system')]
        
            #[Required]
        
        /** @var PostalCodeSystem Postal code system (e.g., 'us_zip', 'gb_outward'). System name encodes country and precision. */
        protected $system;
    
        
            #[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/geo_postal_areas_exclude/items/properties/values')]
        
            #[SchemaName('values')]
        
            #[Required]
        
        /** @var string[] Postal codes to exclude within the system (e.g., ['10001', '10002'] for us_zip) */
        protected $values;
    ...
    /**
     * GetMediaBuysResponse_ItemOfArrayGeo_Postal_Areas_Excludeb3b0176fce8ade5a14c48dbec850724e constructor.
     *
...
if ($additionalProperties =  (static function () use ($modelData): array {
  ...
  0 => 'GetMediaBuysResponse_ItemOfArrayGeo_Postal_Areas_Excludeb3b0176fce8ade5a14c48dbec850724e',
...
(
  ...
  1 => 'php_model_generator_enum',
                 ...
                 *
                 * @param string[] $values Postal codes to exclude within the system (e.g., ['10001', '10002'] for us_zip)
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
...
if ((!is_array($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'array',
                    ...
                    $this->validateValues_ArrayItem_14844a022c93ac457cfc4275cb3fbbff($value, $modelData);
...
private function validateValues_ArrayItem_14844a022c93ac457cfc4275cb3fbbff(&$value, $modelData): void {
