...
/**
 * Builder class for GetMediaBuysRequest_BrandReference
 */
class GetMediaBuysRequest_BrandReferenceBuilder implements BuilderInterface
{
    /** @var array */
    ...
    /**
     * Set up a new instance of GetMediaBuysRequest_BrandReference with fully validated properties
     */
    public function validate(): GetMediaBuysRequest_BrandReference
    {
        ...
        return new GetMediaBuysRequest_BrandReference($this->_rawModelDataInput);
    }
    ...
    private function _array_walk_recursive_real(array &$array, callable $callback): void
    {
        foreach ($array as &$value) {
             ...
             *
             * {@link GetMediaBuysRequest_BrandReference::processDomain}
             * 
             *
             * @return static
             */
             ...
             *
             * {@link GetMediaBuysRequest_BrandReference::processBrandId}
             * 
             *
             * @return static
             */
             ...
             *
             * {@link GetMediaBuysRequest_BrandReference::processIndustries}
             * 
             *
             * @return static
             */
             ...
             *
             * @return GetMediaBuysRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078|GetMediaBuysRequest_Data_Subject_Contestation6ce85a378238546858b122363ebca078Builder|array|null
             */
...
**Merge semantics (normative).** The merge is **field-level**, not whole-object replacement. Each field within `brand_kit_override` (`logo`, `colors`, `voice`, `tagline`) is evaluated independently — when a field is present on the override the override value applies; when a field is absent the brand.json value applies (or is absent if brand.json doesn't carry one either). For composite fields (`colors.primary`, `colors.secondary`, `colors.accent`), the merge is one level deeper: each color slot is evaluated independently — a producer can override `colors.primary` while still inheriting `colors.secondary` from brand.json. SDKs MUST NOT treat a present `brand_kit_override.colors` as wiping the brand.json `colors` block entirely; only the per-slot fields present in the override take precedence. Without this rule, a partial-override semantics would diverge across SDKs and produce inconsistent rendering for the same payload.
             *
             * @return GetMediaBuysRequest_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4|GetMediaBuysRequest_Brand_Kit_Overridecb3f88e49db9b91749c51c9cd1b3e4d4Builder|array|null
             */
