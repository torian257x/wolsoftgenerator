...
/**
 * Class GetProductsRequest_ExtensionObject
...
class GetProductsRequest_ExtensionObject implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    ...
    /**
     * GetProductsRequest_ExtensionObject constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsRequest_ExtensionObject',
)));
}
