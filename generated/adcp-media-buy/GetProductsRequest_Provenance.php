...
/**
 * Class GetProductsRequest_Provenance
...
class GetProductsRequest_Provenance implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/$defs/DigitalSourceType')]
        ...
        protected $digitalSourceType;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/ai_tool')]
        
            #[SchemaName('ai_tool')]
        
        /** @var GetProductsRequest_Ai_Tool866c3fd929909158c718664e57db4355|null AI system used to generate or modify this content. Aligns with IPTC 2025.1 AI metadata fields and C2PA claim_generator. */
        protected $aiTool;
    
        
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/human_oversight')]
        
            #[SchemaName('human_oversight')]
        
        /** @var GetProductsRequest_ProvenanceHuman_Oversight|null Level of human involvement in the AI-assisted creation process. Independent of `disclosure.required` — the protocol does not derive disclosure obligations from oversight level. Some regulations include carve-outs for human-edited or human-directed AI output, but those carve-outs have factual prerequisites the schema cannot evaluate. Asserting `edited` or `directed` does not by itself justify `disclosure.required: false`. */
        protected $humanOversight;
    
        
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/declared_by')]
        
            #[SchemaName('declared_by')]
        
        /** @var GetProductsRequest_Declared_By13c986791ce55365e13a7cd5ff90f7dc|null Party declaring this provenance. Identifies who attached the provenance claim, enabling receiving parties to assess trust. */
        protected $declaredBy;
    
        
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/declared_at')]
        ...
        protected $declaredAt;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/created_time')]
  ...
  11 => 'ext',
    ...
    /**
     * GetProductsRequest_Provenance constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsRequest_Provenance',
)));
}
...
(
  ...
  1 => 'php_model_generator_enum',
                 ...
                 *
                 * @return GetProductsRequest_Ai_Tool866c3fd929909158c718664e57db4355|null
                 */
                public function getAiTool(): ?GetProductsRequest_Ai_Tool866c3fd929909158c718664e57db4355
                {
                 ...
                 *
                 * @param GetProductsRequest_Ai_Tool866c3fd929909158c718664e57db4355 $aiTool AI system used to generate or modify this content. Aligns with IPTC 2025.1 AI metadata fields and C2PA claim_generator.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setAiTool(
                    GetProductsRequest_Ai_Tool866c3fd929909158c718664e57db4355 $aiTool
                ): static {
    ...
    try {
        return is_array($value) ? new GetProductsRequest_Ai_Tool866c3fd929909158c718664e57db4355($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_Ai_Tool866c3fd929909158c718664e57db4355)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'ai_tool',
  1 => 'GetProductsRequest_Ai_Tool866c3fd929909158c718664e57db4355',
)));
}
                 ...
                 *
                 * @return GetProductsRequest_ProvenanceHuman_Oversight|null
                 */
                public function getHumanOversight(): ?GetProductsRequest_ProvenanceHuman_Oversight
                {
...
if ($value instanceof UnitEnum && !($value instanceof GetProductsRequest_ProvenanceHuman_Oversight)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Generic\InvalidTypeException($value ?? null, ...array (
  0 => 'human_oversight',
  1 => 'GetProductsRequest_ProvenanceHuman_Oversight',
)));
}
...
(
    ...
    (function (&$value) use (&$transformationFailed): bool {
        ...
        try {
            $value = \PHPModelGenerator\Filter\Enum::filter($value, array (
  'fqcn' => 'AdCP\\MediaBuy\\Enums\\GetProductsRequest_ProvenanceHuman_Oversight',
));
        } catch (\Throwable $filterException) {
  ...
  1 => 'php_model_generator_enum',
                 ...
                 *
                 * @return GetProductsRequest_Declared_By13c986791ce55365e13a7cd5ff90f7dc|null
                 */
                public function getDeclaredBy(): ?GetProductsRequest_Declared_By13c986791ce55365e13a7cd5ff90f7dc
                {
                 ...
                 *
                 * @param GetProductsRequest_Declared_By13c986791ce55365e13a7cd5ff90f7dc $declaredBy Party declaring this provenance. Identifies who attached the provenance claim, enabling receiving parties to assess trust.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setDeclaredBy(
                    GetProductsRequest_Declared_By13c986791ce55365e13a7cd5ff90f7dc $declaredBy
                ): static {
            ...
            protected function processDeclaredBy(array $modelData): void
            {
                ...
                $value = (function ($value) {
    try {
        return is_array($value) ? new GetProductsRequest_Declared_By13c986791ce55365e13a7cd5ff90f7dc($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_Declared_By13c986791ce55365e13a7cd5ff90f7dc)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'declared_by',
  1 => 'GetProductsRequest_Declared_By13c986791ce55365e13a7cd5ff90f7dc',
)));
}
...
if (!\PHPModelGenerator\Format\FormatValidatorFromRegEx::validate($value, '/^\\d{4}-\\d{2}-\\d{2}[Tt]\\d{2}:\\d{2}:\\d{2}(\\.\\d+)?([Zz]|[+\\-]\\d{2}:\\d{2})$/')) {
  ...
  1 => 'date-time',
                 ...
                 *
                 * @return GetProductsRequest_C2pad8913cd7eeded75f689622ab440bcdb7|null
                 */
                public function getC2pa(): ?GetProductsRequest_C2pad8913cd7eeded75f689622ab440bcdb7
                {
                ...
                public function setC2pa(
                    GetProductsRequest_C2pad8913cd7eeded75f689622ab440bcdb7 $c2pa
                ): static {
                    if ($this->c2pa === $c2pa) {
                        return $this;
                    }
            ...
            protected function processC2pa(array $modelData): void
            {
                ...
                $value = (function ($value) {
    try {
        return is_array($value) ? new GetProductsRequest_C2pad8913cd7eeded75f689622ab440bcdb7($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_C2pad8913cd7eeded75f689622ab440bcdb7)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'c2pa',
  1 => 'GetProductsRequest_C2pad8913cd7eeded75f689622ab440bcdb7',
)));
}
                 ...
                 *
                 * @return GetProductsRequest_ItemOfArrayEmbedded_Provenanceaee6af7d3cac08c369a87561f1ad14f2[]|null
                 */
                 ...
                 *
                 * @param GetProductsRequest_ItemOfArrayEmbedded_Provenanceaee6af7d3cac08c369a87561f1ad14f2[] $embeddedProvenance Provenance metadata embedded within the content stream. Each entry declares one embedding layer: structured provenance data carried inside the content itself, as distinct from sidecar references (c2pa.manifest_url). Embedded provenance survives operations that break sidecar and file-level bindings: ad-server transcoding, CMS ingestion, copy-paste, reformatting, and CDN re-encoding. For ad-tech pipelines where content passes through multiple intermediaries, embedded provenance is the reliable path for provenance that persists from declaration through delivery. This is a declaration by the embedding party. The receiving party (the seller) is the verifier-of-record: it confirms the claim by calling a governance agent it trusts (typically one published in `creative_policy.accepted_verifiers`).
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
...
if ((!is_array($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'array',
                    ...
                    $this->validateEmbeddedProvenance_ArrayItem_63e3d68d637cdde7a89b6ff7d5cb60be($value, $modelData);
...
if (is_array($value) && count($value) < 1) {
  ...
  1 => 1,
                 ...
                 *
                 * @return GetProductsRequest_ItemOfArrayWatermarkse7d5643c5baeff447be3b3636506849c[]|null
                 */
...
if ((!is_array($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'array',
                    ...
                    $this->validateWatermarks_ArrayItem_e2ef2020e06a8f4671dd12131fcc7a3d($value, $modelData);
...
if (is_array($value) && count($value) < 1) {
  ...
  1 => 1,
                 ...
                 *
                 * @return GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982|null
                 */
                public function getDisclosure(): ?GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982
                {
                 ...
                 *
                 * @param GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982 $disclosure Regulatory disclosure requirements for this content. Indicates whether AI disclosure is required and under which jurisdictions.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setDisclosure(
                    GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982 $disclosure
                ): static {
            ...
            protected function processDisclosure(array $modelData): void
            {
                ...
                $value = (function ($value) {
    try {
        return is_array($value) ? new GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'disclosure',
  1 => 'GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982',
)));
}
                 ...
                 *
                 * @return GetProductsRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029e[]|null
                 */
                 ...
                 *
                 * @param GetProductsRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029e[] $verification Third-party verification or detection results for this content. Multiple services may independently evaluate the same content. Provenance is a claim — verification results attached by the declaring party are supplementary. The enforcing party (e.g., seller/publisher) should run its own verification via get_creative_features or calibrate_content.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
...
private function validateEmbeddedProvenance_ArrayItem_63e3d68d637cdde7a89b6ff7d5cb60be(&$value, $modelData): void {
    ...
    foreach ($items as $index => &$value) {
        ...
        try {
            $value = (function ($value) {
    try {
        return is_array($value) ? new GetProductsRequest_ItemOfArrayEmbedded_Provenanceaee6af7d3cac08c369a87561f1ad14f2($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_ItemOfArrayEmbedded_Provenanceaee6af7d3cac08c369a87561f1ad14f2)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'item of array embedded_provenance',
  1 => 'GetProductsRequest_ItemOfArrayEmbedded_Provenanceaee6af7d3cac08c369a87561f1ad14f2',
)));
}
...
private function validateWatermarks_ArrayItem_e2ef2020e06a8f4671dd12131fcc7a3d(&$value, $modelData): void {
    ...
    foreach ($items as $index => &$value) {
        ...
        try {
            $value = (function ($value) {
    try {
        return is_array($value) ? new GetProductsRequest_ItemOfArrayWatermarkse7d5643c5baeff447be3b3636506849c($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_ItemOfArrayWatermarkse7d5643c5baeff447be3b3636506849c)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'item of array watermarks',
  1 => 'GetProductsRequest_ItemOfArrayWatermarkse7d5643c5baeff447be3b3636506849c',
)));
}
...
private function validateVerification_ArrayItem_27e77f091250497a6ea1c127c4ad29ed(&$value, $modelData): void {
    ...
    foreach ($items as $index => &$value) {
        ...
        try {
            $value = (function ($value) {
    try {
        return is_array($value) ? new GetProductsRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029e($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029e)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'item of array verification',
  1 => 'GetProductsRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029e',
)));
}
