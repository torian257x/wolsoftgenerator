...
/**
 * Class GetProductsRequest_Disclosure41c31b1833b6739ac1179c38208fb7a9
...
class GetProductsRequest_Disclosure41c31b1833b6739ac1179c38208fb7a9 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;
        ...
        /** @var GetProductsRequest_ItemOfArrayJurisdictions5b5f842a447a24db3a9dc59f6a4c2987[]|null Jurisdictions where disclosure obligations apply */
  ...
  1 => 'jurisdictions',
    ...
    /**
     * GetProductsRequest_Disclosure41c31b1833b6739ac1179c38208fb7a9 constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsRequest_Disclosure41c31b1833b6739ac1179c38208fb7a9',
)));
}
...
if ((!is_bool($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'bool',
                 ...
                 *
                 * @return GetProductsRequest_ItemOfArrayJurisdictions5b5f842a447a24db3a9dc59f6a4c2987[]|null
                 */
                 ...
                 *
                 * @param GetProductsRequest_ItemOfArrayJurisdictions5b5f842a447a24db3a9dc59f6a4c2987[] $jurisdictions Jurisdictions where disclosure obligations apply
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
...
if ((!is_array($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'array',
                    ...
                    $this->validateJurisdictions_ArrayItem_3071e1777206c99d02b267dfd4eb21e2($value, $modelData);
...
private function validateJurisdictions_ArrayItem_3071e1777206c99d02b267dfd4eb21e2(&$value, $modelData): void {
    ...
    try {
        return is_array($value) ? new GetProductsRequest_ItemOfArrayJurisdictions5b5f842a447a24db3a9dc59f6a4c2987($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_ItemOfArrayJurisdictions5b5f842a447a24db3a9dc59f6a4c2987)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'item of array jurisdictions',
  1 => 'GetProductsRequest_ItemOfArrayJurisdictions5b5f842a447a24db3a9dc59f6a4c2987',
)));
}
