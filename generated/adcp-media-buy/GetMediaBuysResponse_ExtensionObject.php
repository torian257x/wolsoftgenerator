...
/**
 * Class GetMediaBuysResponse_ExtensionObject
...
class GetMediaBuysResponse_ExtensionObject implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    ...
    /**
     * GetMediaBuysResponse_ExtensionObject constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetMediaBuysResponse_ExtensionObject',
)));
}
