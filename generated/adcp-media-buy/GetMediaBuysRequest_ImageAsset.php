...
/**
 * Class GetMediaBuysRequest_ImageAsset
...
class GetMediaBuysRequest_ImageAsset implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;
        ...
        /** @var GetMediaBuysRequest_Provenance|null Provenance metadata for this asset, overrides manifest-level provenance */
  ...
  6 => 'provenance',
    ...
    /**
     * GetMediaBuysRequest_ImageAsset constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetMediaBuysRequest_ImageAsset',
)));
}
...
if ((!is_string($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'string',
                 ...
                 *
                 * @return GetMediaBuysRequest_Provenance|null
                 */
                public function getProvenance(): ?GetMediaBuysRequest_Provenance
                {
                 ...
                 *
                 * @param GetMediaBuysRequest_Provenance $provenance Provenance metadata for this asset, overrides manifest-level provenance
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setProvenance(
                    GetMediaBuysRequest_Provenance $provenance
                ): static {
    ...
    try {
        return is_array($value) ? new GetMediaBuysRequest_Provenance($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuysRequest_Provenance)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'provenance',
  1 => 'GetMediaBuysRequest_Provenance',
)));
}
