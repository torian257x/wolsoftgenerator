...
/**
 * Class GetMediaBuysResponse_ItemOfArrayGeo_Metros6f0aaa0fc5b789ffaf488638fb98921e
...
#[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/geo_metros/items')]

class GetMediaBuysResponse_ItemOfArrayGeo_Metros6f0aaa0fc5b789ffaf488638fb98921e implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;
        ...
        protected $system;
            ...
            #[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/geo_metros/items/properties/values')]
        
            #[SchemaName('values')]
        
            #[Required]
        
        /** @var string[] Metro codes within the system (e.g., ['501', '602'] for Nielsen DMAs) */
        protected $values;
    ...
    /**
     * GetMediaBuysResponse_ItemOfArrayGeo_Metros6f0aaa0fc5b789ffaf488638fb98921e constructor.
     *
...
if ($additionalProperties =  (static function () use ($modelData): array {
  ...
  0 => 'GetMediaBuysResponse_ItemOfArrayGeo_Metros6f0aaa0fc5b789ffaf488638fb98921e',
...
if ((!is_array($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'array',
                    ...
                    $this->validateValues_ArrayItem_9408f171425324c2f26bf779e5f5538b($value, $modelData);
...
private function validateValues_ArrayItem_9408f171425324c2f26bf779e5f5538b(&$value, $modelData): void {
