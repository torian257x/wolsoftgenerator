...
/**
 * Class GetMediaBuysResponse_Duration
...
#[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/frequency_cap/properties/suppress/allOf/0')]

class GetMediaBuysResponse_Duration implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/frequency_cap/properties/suppress/allOf/0/properties/interval')]
        ...
        protected $interval;
            ...
            #[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/frequency_cap/properties/suppress/allOf/0/properties/unit')]
        
            #[SchemaName('unit')]
        
            #[Required]
        
        /** @var GetMediaBuysResponse_DurationUnit Time unit. 'seconds' for sub-minute precision. 'campaign' spans the full campaign flight. */
        protected $unit;
    ...
    /**
     * GetMediaBuysResponse_Duration constructor.
     *
...
if ($additionalProperties =  (static function () use ($modelData): array {
  ...
  0 => 'GetMediaBuysResponse_Duration',
...
if (is_int($value) && $value < 1) {
  ...
  1 => 1,
                 ...
                 *
                 * @return GetMediaBuysResponse_DurationUnit
                 */
                public function getUnit(): GetMediaBuysResponse_DurationUnit
                {
...
if ($value instanceof UnitEnum && !($value instanceof GetMediaBuysResponse_DurationUnit)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Generic\InvalidTypeException($value ?? null, ...array (
  0 => 'unit',
  1 => 'GetMediaBuysResponse_DurationUnit',
)));
}
...
(
  ...
  'fqcn' => 'AdCP\\MediaBuy\\Enums\\GetMediaBuysResponse_DurationUnit',
));
