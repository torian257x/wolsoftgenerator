...
/**
 * Class GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029e
...
#[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/verification/items')]

class GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029e implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/verification/items/properties/verified_by')]
        ...
        protected $verifiedBy;
            ...
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/verification/items/properties/verified_time')]
        ...
        protected $verifiedTime;
            ...
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/verification/items/properties/result')]
        
            #[SchemaName('result')]
        
            #[Required]
        
        /** @var GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029eResult Verification outcome */
        protected $result;
    
        
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/verification/items/properties/confidence')]
        ...
        protected $confidence;
            ...
            #[JsonPointer('/properties/account/oneOf/1/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/verification/items/properties/details_url')]
  ...
  4 => 'details_url',
    ...
    /**
     * GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029e constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029e',
)));
}
...
if (!\PHPModelGenerator\Format\FormatValidatorFromRegEx::validate($value, '/^\\d{4}-\\d{2}-\\d{2}[Tt]\\d{2}:\\d{2}:\\d{2}(\\.\\d+)?([Zz]|[+\\-]\\d{2}:\\d{2})$/')) {
  ...
  1 => 'date-time',
                 ...
                 *
                 * @return GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029eResult
                 */
                public function getResult(): GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029eResult
                {
                 ...
                 *
                 * @param string|GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029eResult $result Verification outcome
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setResult(
                    string | GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029eResult $result
                ): static {
...
if ($value instanceof UnitEnum && !($value instanceof GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029eResult)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Generic\InvalidTypeException($value ?? null, ...array (
  0 => 'result',
  1 => 'GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029eResult',
)));
}
...
(
  ...
  'fqcn' => 'AdCP\\MediaBuy\\Enums\\GetMediaBuysRequest_ItemOfArrayVerificationab0379bc9ff851960f9f645c9916029eResult',
));
