...
/**
 * Class GetMediaBuysResponse_GetMediaBuysResponse_ItemOfArrayGeo_Proximity014570a07fc3e7d618cb16a2c40b339f1d52d88f0d009813f8b6db3574d377d6
...
#[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/geo_proximity/items/oneOf/1')]

class GetMediaBuysResponse_GetMediaBuysResponse_ItemOfArrayGeo_Proximity014570a07fc3e7d618cb16a2c40b339f1d52d88f0d009813f8b6db3574d377d6 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/geo_proximity/items/oneOf/1/properties/lat')]
        ...
        protected $lat;
            ...
            #[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/geo_proximity/items/oneOf/1/properties/lng')]
        ...
        protected $lng;
            ...
            #[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/geo_proximity/items/oneOf/1/properties/radius')]
  ...
  array (
    ...
    /**
     * GetMediaBuysResponse_GetMediaBuysResponse_ItemOfArrayGeo_Proximity014570a07fc3e7d618cb16a2c40b339f1d52d88f0d009813f8b6db3574d377d6 constructor.
     *
...
(function (&$value) use (
    ...
    try {
        return is_array($value) ? new GetMediaBuysResponse_GetMediaBuysResponse_GetMediaBuysResponse_ItemOfArrayGeo_Proximity014570a07fc3e7d618cb16a2c40b339f1d52d88f0d009813f8b6db3574d377d6537e7d8420e439b439bbf2dc6a609664($value) : $value;
...
if ((!is_object($value) && !$value instanceof UnitEnum) ) {
  ...
  0 => 'GetMediaBuysResponse_GetMediaBuysResponse_ItemOfArrayGeo_Proximity014570a07fc3e7d618cb16a2c40b339f1d52d88f0d009813f8b6db3574d377d6',
  1 => 'object',
)));
}
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuysResponse_GetMediaBuysResponse_GetMediaBuysResponse_ItemOfArrayGeo_Proximity014570a07fc3e7d618cb16a2c40b339f1d52d88f0d009813f8b6db3574d377d6537e7d8420e439b439bbf2dc6a609664)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'GetMediaBuysResponse_GetMediaBuysResponse_ItemOfArrayGeo_Proximity014570a07fc3e7d618cb16a2c40b339f1d52d88f0d009813f8b6db3574d377d6',
  1 => 'GetMediaBuysResponse_GetMediaBuysResponse_GetMediaBuysResponse_ItemOfArrayGeo_Proximity014570a07fc3e7d618cb16a2c40b339f1d52d88f0d009813f8b6db3574d377d6537e7d8420e439b439bbf2dc6a609664',
)));
}
                ...
                if (is_object($value) && is_array($originalModelData)) {
                    $modifiedValues = array_merge($modifiedValues, $this->_getModifiedValues_34ccf($originalModelData, $value));
                }
...
public function populate(array $modelData): self
{
    ...
    return $this;
                        ...
                        private function _getModifiedValues_34ccf(array $originalModelData, object $nestedCompositionObject): array {
                            $modifiedValues = [];
