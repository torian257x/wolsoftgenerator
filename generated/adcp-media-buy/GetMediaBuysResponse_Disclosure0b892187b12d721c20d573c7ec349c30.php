...
/**
 * Class GetMediaBuysResponse_Disclosure0b892187b12d721c20d573c7ec349c30
...
class GetMediaBuysResponse_Disclosure0b892187b12d721c20d573c7ec349c30 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/media_buys/items/properties/account/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/disclosure/properties/required')]
        ...
        protected $required;
            ...
            #[JsonPointer('/properties/media_buys/items/properties/account/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/disclosure/properties/jurisdictions')]
        
            #[SchemaName('jurisdictions')]
        
        /** @var GetMediaBuysResponse_ItemOfArrayJurisdictions8bf29d4207dd31b988e71fd7e02eded3[]|null Jurisdictions where disclosure obligations apply */
  ...
  1 => 'jurisdictions',
    ...
    /**
     * GetMediaBuysResponse_Disclosure0b892187b12d721c20d573c7ec349c30 constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetMediaBuysResponse_Disclosure0b892187b12d721c20d573c7ec349c30',
)));
}
...
if ((!is_bool($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'bool',
                 ...
                 *
                 * @return GetMediaBuysResponse_ItemOfArrayJurisdictions8bf29d4207dd31b988e71fd7e02eded3[]|null
                 */
                 ...
                 *
                 * @param GetMediaBuysResponse_ItemOfArrayJurisdictions8bf29d4207dd31b988e71fd7e02eded3[] $jurisdictions Jurisdictions where disclosure obligations apply
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
...
private function validateJurisdictions_ArrayItem_c4ae9add62a81c9748f7f5f86e91c77f(&$value, $modelData): void {
    ...
    try {
        return is_array($value) ? new GetMediaBuysResponse_ItemOfArrayJurisdictions8bf29d4207dd31b988e71fd7e02eded3($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuysResponse_ItemOfArrayJurisdictions8bf29d4207dd31b988e71fd7e02eded3)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'item of array jurisdictions',
  1 => 'GetMediaBuysResponse_ItemOfArrayJurisdictions8bf29d4207dd31b988e71fd7e02eded3',
)));
}
