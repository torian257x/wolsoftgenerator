...
/**
 * Class GetMediaBuysRequest_AccountReference
...
class GetMediaBuysRequest_AccountReference implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;
        ...
        /** @var GetMediaBuysRequest_BrandReference|null Brand reference identifying the advertiser */
        protected $brand;
  ...
  2 => 'operator',
    ...
    /**
     * GetMediaBuysRequest_AccountReference constructor.
     *
    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
            ...
            protected function validateAccountId($value, array $modelData)
            {
                 ...
                 *
                 * @return GetMediaBuysRequest_BrandReference|null
                 */
                 ...
                 *
                 * @param GetMediaBuysRequest_BrandReference|null $brand Brand reference identifying the advertiser
                 *
                 * 
                 *
                 * @return static
...
(function (&$value) use (
    ...
    $modifiedValues = [];
        ...
        try {
                ...
                $value = (function ($value) {
    try {
        return is_array($value) ? new GetMediaBuysRequest_GetMediaBuysRequest_AccountReference391339b2537fe704903ad118e237c1c0($value) : $value;
    } catch (\Exception $instantiationException) {
...
if ((!is_object($value) && !$value instanceof UnitEnum) ) {
  ...
  0 => 'GetMediaBuysRequest_AccountReference',
  1 => 'object',
)));
}
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuysRequest_GetMediaBuysRequest_AccountReference391339b2537fe704903ad118e237c1c0)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'GetMediaBuysRequest_AccountReference',
  1 => 'GetMediaBuysRequest_GetMediaBuysRequest_AccountReference391339b2537fe704903ad118e237c1c0',
)));
}
                ...
                if (is_object($value) && is_array($originalModelData)) {
                    $modifiedValues = array_merge($modifiedValues, $this->_getModifiedValues_18d43($originalModelData, $value));
                }
        ...
        try {
                ...
                $value = (function ($value) {
    try {
        return is_array($value) ? new GetMediaBuysRequest_GetMediaBuysRequest_AccountReference4150dd996f9e6edfbc4269852855249a($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuysRequest_GetMediaBuysRequest_AccountReference4150dd996f9e6edfbc4269852855249a)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'GetMediaBuysRequest_AccountReference',
  1 => 'GetMediaBuysRequest_GetMediaBuysRequest_AccountReference4150dd996f9e6edfbc4269852855249a',
)));
}
...
public function populate(array $modelData): self
{
    ...
    return $this;
                        ...
                        private function _getModifiedValues_18d43(array $originalModelData, object $nestedCompositionObject): array {
                            $modifiedValues = [];
