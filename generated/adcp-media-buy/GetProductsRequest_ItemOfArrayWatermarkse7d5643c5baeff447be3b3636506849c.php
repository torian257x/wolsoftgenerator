...
/**
 * Class GetProductsRequest_ItemOfArrayWatermarkse7d5643c5baeff447be3b3636506849c
...
#[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/watermarks/items')]

class GetProductsRequest_ItemOfArrayWatermarkse7d5643c5baeff447be3b3636506849c implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/$defs/WatermarkMediaType')]
        ...
        protected $mediaType;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/watermarks/items/properties/provider')]
        ...
        protected $c2paAction;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/watermarks/items/properties/embedded_at')]
  ...
  4 => 'embedded_at',
    ...
    /**
     * GetProductsRequest_ItemOfArrayWatermarkse7d5643c5baeff447be3b3636506849c constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsRequest_ItemOfArrayWatermarkse7d5643c5baeff447be3b3636506849c',
)));
}
...
if ((!is_string($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'string',
                 ...
                 *
                 * @return GetProductsRequest_Verify_Agentbcc150a81b5d33f22392dcef014818e1|null
                 */
                public function getVerifyAgent(): ?GetProductsRequest_Verify_Agentbcc150a81b5d33f22392dcef014818e1
                {
                ...
                public function setVerifyAgent(
                    GetProductsRequest_Verify_Agentbcc150a81b5d33f22392dcef014818e1 $verifyAgent
                ): static {
    ...
    try {
        return is_array($value) ? new GetProductsRequest_Verify_Agentbcc150a81b5d33f22392dcef014818e1($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_Verify_Agentbcc150a81b5d33f22392dcef014818e1)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'verify_agent',
  1 => 'GetProductsRequest_Verify_Agentbcc150a81b5d33f22392dcef014818e1',
)));
}
