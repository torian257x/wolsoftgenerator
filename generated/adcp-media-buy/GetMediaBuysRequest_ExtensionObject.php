...
/**
 * Class GetMediaBuysRequest_ExtensionObject
...
class GetMediaBuysRequest_ExtensionObject implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    ...
    /**
     * GetMediaBuysRequest_ExtensionObject constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetMediaBuysRequest_ExtensionObject',
)));
}
