...
/**
 * Class GetMediaBuysResponse_CollectionListReference
...
class GetMediaBuysResponse_CollectionListReference implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/collection_list/properties/agent_url')]
        
            #[SchemaName('agent_url')]
        
            #[Required]
        
        /** @var string URL of the agent managing the collection list */
        protected $agentUrl;
    
        
            #[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/collection_list/properties/list_id')]
        
            #[SchemaName('list_id')]
        
            #[Required]
        
        /** @var string Identifier for the collection list within the agent */
        protected $listId;
    
        
            #[JsonPointer('/properties/media_buys/items/properties/packages/items/properties/targeting_overlay/properties/collection_list/properties/auth_token')]
  ...
  2 => 'auth_token',
    ...
    /**
     * GetMediaBuysResponse_CollectionListReference constructor.
     *
...
if ($additionalProperties =  (static function () use ($modelData): array {
  ...
  0 => 'GetMediaBuysResponse_CollectionListReference',
