...
/**
 * Class GetProductsRequest_ItemOfArrayEmbedded_Provenanceaee6af7d3cac08c369a87561f1ad14f2
...
#[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/embedded_provenance/items')]

class GetProductsRequest_ItemOfArrayEmbedded_Provenanceaee6af7d3cac08c369a87561f1ad14f2 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/$defs/EmbeddedProvenanceMethod')]
        ...
        protected $method;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/embedded_provenance/items/properties/standard')]
        ...
        protected $standard;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/embedded_provenance/items/properties/provider')]
  ...
  4 => 'embedded_at',
    ...
    /**
     * GetProductsRequest_ItemOfArrayEmbedded_Provenanceaee6af7d3cac08c369a87561f1ad14f2 constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsRequest_ItemOfArrayEmbedded_Provenanceaee6af7d3cac08c369a87561f1ad14f2',
)));
}
...
if ((!is_string($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'string',
                 ...
                 *
                 * @return GetProductsRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5|null
                 */
                public function getVerifyAgent(): ?GetProductsRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5
                {
                 ...
                 *
                 * @param GetProductsRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5 $verifyAgent Buyer's representation that this embedding can be verified by a governance agent on the seller's `creative_policy.accepted_verifiers` list. The `agent_url` MUST match (canonicalized) one of the seller's published `accepted_verifiers[].agent_url` entries; sellers reject `sync_creatives` submissions whose `verify_agent.agent_url` is off-list with `PROVENANCE_VERIFIER_NOT_ACCEPTED`. This is buyer-supplied evidence, not buyer-driven routing — the seller is the verifier-of-record and the seller controls which agent it actually calls (the seller MAY use a different on-list agent if it determines this is more appropriate; the seller does not call buyer-asserted endpoints outside its allowlist). MAY be omitted for self-verifiable embeddings (e.g., a C2PA text manifest with a public key the seller already trusts).
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setVerifyAgent(
                    GetProductsRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5 $verifyAgent
                ): static {
    ...
    try {
        return is_array($value) ? new GetProductsRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'verify_agent',
  1 => 'GetProductsRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5',
)));
}
