...
/**
 * Class GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982
...
class GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/disclosure/properties/required')]
        ...
        protected $required;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/disclosure/properties/jurisdictions')]
        
            #[SchemaName('jurisdictions')]
        
        /** @var GetProductsRequest_ItemOfArrayJurisdictionsd5e085cc01dc6653e1e690129910a04b[]|null Jurisdictions where disclosure obligations apply */
  ...
  1 => 'jurisdictions',
    ...
    /**
     * GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982 constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsRequest_Disclosure857d3ff40c0b635f01f4dd6c336d9982',
)));
}
...
if ((!is_bool($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'bool',
                 ...
                 *
                 * @return GetProductsRequest_ItemOfArrayJurisdictionsd5e085cc01dc6653e1e690129910a04b[]|null
                 */
                 ...
                 *
                 * @param GetProductsRequest_ItemOfArrayJurisdictionsd5e085cc01dc6653e1e690129910a04b[] $jurisdictions Jurisdictions where disclosure obligations apply
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
...
if ((!is_array($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'array',
                    ...
                    $this->validateJurisdictions_ArrayItem_15bec9129cfb9189169aa18e3143a118($value, $modelData);
...
private function validateJurisdictions_ArrayItem_15bec9129cfb9189169aa18e3143a118(&$value, $modelData): void {
    ...
    try {
        return is_array($value) ? new GetProductsRequest_ItemOfArrayJurisdictionsd5e085cc01dc6653e1e690129910a04b($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_ItemOfArrayJurisdictionsd5e085cc01dc6653e1e690129910a04b)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'item of array jurisdictions',
  1 => 'GetProductsRequest_ItemOfArrayJurisdictionsd5e085cc01dc6653e1e690129910a04b',
)));
}
