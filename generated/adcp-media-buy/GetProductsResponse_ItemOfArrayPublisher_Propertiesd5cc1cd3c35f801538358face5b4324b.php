...
/**
 * Class GetProductsResponse_ItemOfArrayPublisher_Propertiesd5cc1cd3c35f801538358face5b4324b
...
#[JsonPointer('/properties/products/items/properties/publisher_properties/items/allOf/0/oneOf/2')]

class GetProductsResponse_ItemOfArrayPublisher_Propertiesd5cc1cd3c35f801538358face5b4324b implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/products/items/properties/publisher_properties/items/allOf/0/oneOf/2/properties/publisher_domain')]
        ...
        protected $publisherDomain;
            ...
            #[JsonPointer('/properties/products/items/properties/publisher_properties/items/allOf/0/oneOf/2/properties/publisher_domains')]
        
            #[SchemaName('publisher_domains')]
        
        /** @var string[]|null Compact form for fanning the same tag predicate across many publishers (canonical managed-network shape). Each entry is the domain where that publisher's adagents.json is hosted. Each listed domain MUST be canonicalized to lowercase (the `pattern` already rejects uppercase). Mutually exclusive with `publisher_domain`. Each listed domain counts as explicitly scoped for the `managerdomain` fallback safety rule. */
        protected $publisherDomains;
    
        
            #[JsonPointer('/properties/products/items/properties/publisher_properties/items/allOf/0/oneOf/2/properties/selection_type')]
        
            #[SchemaName('selection_type')]
        
            #[Required]
        
        /** @var string Discriminator indicating selection by property tags */
        protected $selectionType;
    
        
            #[JsonPointer('/properties/products/items/properties/publisher_properties/items/allOf/0/oneOf/2/properties/property_tags')]
        
            #[SchemaName('property_tags')]
        
            #[Required]
        
        /** @var string[] Property tags resolved against each addressed publisher's adagents.json, OR against the parent file's top-level `properties[]` when those properties carry a `publisher_domain` matching the selector. Selector covers all properties carrying any of these tags. */
  ...
  1 => 'publisher_domains',
    ...
    /**
     * GetProductsResponse_ItemOfArrayPublisher_Propertiesd5cc1cd3c35f801538358face5b4324b constructor.
     *
    ...
    public function __construct(array $rawModelDataInput = [])
    {
            ...
            $this->executeBaseValidators($rawModelDataInput);
                ...
                $this->processPropertyTags($rawModelDataInput);
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsResponse_ItemOfArrayPublisher_Propertiesd5cc1cd3c35f801538358face5b4324b',
)));
}
...
if (is_string($value) && !preg_match(base64_decode('L15bYS16MC05XShbYS16MC05LV0qW2EtejAtOV0pPyhcLlthLXowLTldKFthLXowLTktXSpbYS16MC05XSk/KSokLw=='), $value)) {
  ...
  1 => '^[a-z0-9]([a-z0-9-]*[a-z0-9])?(\\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$',
                 ...
                 *
                 * Compact form for fanning the same tag predicate across many publishers (canonical managed-network shape). Each entry is the domain where that publisher's adagents.json is hosted. Each listed domain MUST be canonicalized to lowercase (the `pattern` already rejects uppercase). Mutually exclusive with `publisher_domain`. Each listed domain counts as explicitly scoped for the `managerdomain` fallback safety rule.
                 *
                 * @return string[]|null
                 */
                 ...
                 *
                 * @param string[] $publisherDomains Compact form for fanning the same tag predicate across many publishers (canonical managed-network shape). Each entry is the domain where that publisher's adagents.json is hosted. Each listed domain MUST be canonicalized to lowercase (the `pattern` already rejects uppercase). Mutually exclusive with `publisher_domain`. Each listed domain counts as explicitly scoped for the `managerdomain` fallback safety rule.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
...
if ((!is_array($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'array',
                    ...
                    $this->validatePublisherDomains_ArrayItem_f52fff3712f2dbf89596e3808dc52d59($value, $modelData);
...
if (is_array($value) && (static function (array $items): bool {
  ...
  0 => 'publisher_domains',
                 ...
                 *
                 * @param string $selectionType Discriminator indicating selection by property tags
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
...
if ($value !== 'by_tag') {
  ...
  1 => 'by_tag',
                ...
                /**
                 * Get the value of property_tags.
                 *
                ...
                /**
                 * Set the value of property_tags.
                 *
                 * @param string[] $propertyTags Property tags resolved against each addressed publisher's adagents.json, OR against the parent file's top-level `properties[]` when those properties carry a `publisher_domain` matching the selector. Selector covers all properties carrying any of these tags.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                 */
                public function setPropertyTags(
                    array $propertyTags
                ): static {
                    if ($this->propertyTags === $propertyTags) {
                        return $this;
                    }

                    $value = $modelData['property_tags'] = $propertyTags;
                    ...
                    $value = $this->validatePropertyTags($value, $modelData);
                    ...
                    $this->_rawModelDataInput['property_tags'] = $propertyTags;
            ...
            /**
             * Extract the value, perform validations and set the property propertyTags
             *
             * @param array $modelData
             *
             * @throws ErrorRegistryException
             */
            protected function processPropertyTags(array $modelData): void
            {
                

                $value = array_key_exists('property_tags', $modelData) ? $modelData['property_tags'] : $this->propertyTags;

                

                $this->propertyTags = $this->validatePropertyTags($value, $modelData);
            }

            /**
             * Execute all validators for the property propertyTags
             */
            protected function validatePropertyTags($value, array $modelData)
            {
                
                    

if (!array_key_exists('property_tags', $modelData)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\RequiredValueException($value ?? null, ...array (
  0 => 'property_tags',
)));
}
...
if ((!is_array($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'array',
                    ...
                    $this->validatePropertyTags_ArrayItem_3461a4e71b6a8524e9e95a620e411960($value, $modelData);
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsResponse_GetProductsResponse_ItemOfArrayPublisher_Properties356f954b5f22f2cf551a8fa9ab8cc12703f868fa5f53a2303f3ad893d57ebc13)) {
  ...
  1 => 'GetProductsResponse_GetProductsResponse_ItemOfArrayPublisher_Properties356f954b5f22f2cf551a8fa9ab8cc12703f868fa5f53a2303f3ad893d57ebc13',
                ...
                if (is_object($value) && is_array($originalModelData)) {
                    $modifiedValues = array_merge($modifiedValues, $this->_getModifiedValues_640e0($originalModelData, $value));
                }
...
public function populate(array $modelData): self
{
    ...
    foreach (['_additionalProperties', '_patternProperties'] as $property) {
        ...
        $this->executeBaseValidators($modelData);
            ...
            if (array_key_exists('property_tags', $modelData) &&
                $modelData['property_tags'] !== $this->propertyTags
            ) {
                



                $rollbackValues['propertyTags'] = $this->propertyTags;
                $this->processPropertyTags($modelData);
            }
...
private function validatePublisherDomains_ArrayItem_f52fff3712f2dbf89596e3808dc52d59(&$value, $modelData): void {
...
private function validatePropertyTags_ArrayItem_3461a4e71b6a8524e9e95a620e411960(&$value, $modelData): void {
                    $invalidItems_64d25e26598a18a16c9f5dc75387c02a = [];
                    
                    if (is_array($value) && (function (&$items) use (&$invalidItems_64d25e26598a18a16c9f5dc75387c02a, $modelData) {
...
if (is_string($value) && !preg_match(base64_decode('L15bYS16MC05X10rJC8='), $value)) {
  ...
  1 => '^[a-z0-9_]+$',
                ...
                if ($this->_errorRegistry->getErrors()) {
                    $invalidItems_64d25e26598a18a16c9f5dc75387c02a[$index] = $this->_errorRegistry->getErrors();
                }
            
        } catch (\Exception $e) {
            // collect all errors concerning invalid items
            isset($invalidItems_64d25e26598a18a16c9f5dc75387c02a[$index])
                ? $invalidItems_64d25e26598a18a16c9f5dc75387c02a[$index][] = $e
                : $invalidItems_64d25e26598a18a16c9f5dc75387c02a[$index] = [$e];
        }
    }
    ...
    return !empty($invalidItems_64d25e26598a18a16c9f5dc75387c02a);
})($value)) {
                        $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Arrays\InvalidItemException($value ?? null, ...array (
  0 => 'property_tags',
  1 => $invalidItems_64d25e26598a18a16c9f5dc75387c02a,
)));
                    }
                }


                        private function _getModifiedValues_640e0(array $originalModelData, object $nestedCompositionObject): array {
                            $modifiedValues = [];
