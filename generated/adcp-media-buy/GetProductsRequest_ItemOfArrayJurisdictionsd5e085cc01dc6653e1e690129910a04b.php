...
/**
 * Class GetProductsRequest_ItemOfArrayJurisdictionsd5e085cc01dc6653e1e690129910a04b
...
#[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/disclosure/properties/jurisdictions/items')]

class GetProductsRequest_ItemOfArrayJurisdictionsd5e085cc01dc6653e1e690129910a04b implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/disclosure/properties/jurisdictions/items/properties/country')]
        ...
        protected $country;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/disclosure/properties/jurisdictions/items/properties/region')]
        ...
        protected $region;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/disclosure/properties/jurisdictions/items/properties/regulation')]
        ...
        protected $regulation;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/disclosure/properties/jurisdictions/items/properties/label_text')]
        ...
        protected $labelText;
            ...
            #[JsonPointer('/properties/brand/properties/brand_kit_override/properties/logo/properties/provenance/properties/disclosure/properties/jurisdictions/items/properties/render_guidance')]
        
            #[SchemaName('render_guidance')]
        
        /** @var GetProductsRequest_Render_Guidance4a20c095eb42a5b371130b98c0e4fcc1|null How the disclosure should be rendered for this jurisdiction. Expresses the declaring party's intent for persistence and position based on regulatory requirements. Publishers control actual rendering but governance agents can audit whether guidance was followed. */
  ...
  4 => 'render_guidance',
    ...
    /**
     * GetProductsRequest_ItemOfArrayJurisdictionsd5e085cc01dc6653e1e690129910a04b constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsRequest_ItemOfArrayJurisdictionsd5e085cc01dc6653e1e690129910a04b',
)));
}
...
if ((!is_string($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'string',
                 ...
                 *
                 * @return GetProductsRequest_Render_Guidance4a20c095eb42a5b371130b98c0e4fcc1|null
                 */
                public function getRenderGuidance(): ?GetProductsRequest_Render_Guidance4a20c095eb42a5b371130b98c0e4fcc1
                {
                 ...
                 *
                 * @param GetProductsRequest_Render_Guidance4a20c095eb42a5b371130b98c0e4fcc1 $renderGuidance How the disclosure should be rendered for this jurisdiction. Expresses the declaring party's intent for persistence and position based on regulatory requirements. Publishers control actual rendering but governance agents can audit whether guidance was followed.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setRenderGuidance(
                    GetProductsRequest_Render_Guidance4a20c095eb42a5b371130b98c0e4fcc1 $renderGuidance
                ): static {
    ...
    try {
        return is_array($value) ? new GetProductsRequest_Render_Guidance4a20c095eb42a5b371130b98c0e4fcc1($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_Render_Guidance4a20c095eb42a5b371130b98c0e4fcc1)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'render_guidance',
  1 => 'GetProductsRequest_Render_Guidance4a20c095eb42a5b371130b98c0e4fcc1',
)));
}
