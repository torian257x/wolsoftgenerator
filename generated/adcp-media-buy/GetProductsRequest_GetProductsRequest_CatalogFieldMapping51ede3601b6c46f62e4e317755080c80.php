...
/**
 * Class GetProductsRequest_GetProductsRequest_CatalogFieldMapping51ede3601b6c46f62e4e317755080c80
...
#[JsonPointer('/properties/catalog/properties/feed_field_mappings/items/allOf/0')]

class GetProductsRequest_GetProductsRequest_CatalogFieldMapping51ede3601b6c46f62e4e317755080c80 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
  ...
  array (
    ...
    /**
     * GetProductsRequest_GetProductsRequest_CatalogFieldMapping51ede3601b6c46f62e4e317755080c80 constructor.
     *
...
(function (&$value) use (
    ...
    try {
        return is_array($value) ? new GetProductsRequest_GetProductsRequest_GetProductsRequest_CatalogFieldMapping51ede3601b6c46f62e4e317755080c80017d8c78b30fa85cd12e0d3092fd35ab($value) : $value;
...
if ((!is_object($value) && !$value instanceof UnitEnum) ) {
  ...
  0 => 'GetProductsRequest_GetProductsRequest_CatalogFieldMapping51ede3601b6c46f62e4e317755080c80',
  1 => 'object',
)));
}
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_GetProductsRequest_GetProductsRequest_CatalogFieldMapping51ede3601b6c46f62e4e317755080c80017d8c78b30fa85cd12e0d3092fd35ab)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'GetProductsRequest_GetProductsRequest_CatalogFieldMapping51ede3601b6c46f62e4e317755080c80',
  1 => 'GetProductsRequest_GetProductsRequest_GetProductsRequest_CatalogFieldMapping51ede3601b6c46f62e4e317755080c80017d8c78b30fa85cd12e0d3092fd35ab',
)));
}
                ...
                if (is_object($value) && is_array($originalModelData)) {
                    $modifiedValues = array_merge($modifiedValues, $this->_getModifiedValues_94062($originalModelData, $value));
                }
...
public function populate(array $modelData): self
{
    ...
    return $this;
                        ...
                        private function _getModifiedValues_94062(array $originalModelData, object $nestedCompositionObject): array {
                            $modifiedValues = [];
