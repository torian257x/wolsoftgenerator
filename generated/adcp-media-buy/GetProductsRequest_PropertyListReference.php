...
/**
 * Class GetProductsRequest_PropertyListReference
...
class GetProductsRequest_PropertyListReference implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/property_list/properties/agent_url')]
        ...
        protected $agentUrl;
            ...
            #[JsonPointer('/properties/property_list/properties/list_id')]
        ...
        protected $listId;
            ...
            #[JsonPointer('/properties/property_list/properties/auth_token')]
  ...
  2 => 'auth_token',
    ...
    /**
     * GetProductsRequest_PropertyListReference constructor.
     *
...
if ($additionalProperties =  (static function () use ($modelData): array {
  ...
  0 => 'GetProductsRequest_PropertyListReference',
