...
/**
 * Class GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765
...
class GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765 implements JSONModelInterface, JsonSerializable, SerializationInterface
{
  ...
  4 => 'embedded_at',
    ...
    /**
     * GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765 constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765',
)));
}
...
if ((!is_string($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'string',
                 ...
                 *
                 * @return GetMediaBuysRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5|null
                 */
                public function getVerifyAgent(): ?GetMediaBuysRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5
                {
                ...
                public function setVerifyAgent(
                    GetMediaBuysRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5 $verifyAgent
                ): static {
    ...
    try {
        return is_array($value) ? new GetMediaBuysRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuysRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'verify_agent',
  1 => 'GetMediaBuysRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5',
)));
}
