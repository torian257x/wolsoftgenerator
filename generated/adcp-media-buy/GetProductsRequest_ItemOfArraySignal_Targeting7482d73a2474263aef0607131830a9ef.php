...
/**
 * Class GetProductsRequest_ItemOfArraySignal_Targeting7482d73a2474263aef0607131830a9ef
 * @package AdCP\MediaBuy 
 *
 * Binary signal targeting - user either matches or doesn't
 *
...
#[JsonPointer('/properties/filters/properties/signal_targeting/items/oneOf/0')]

class GetProductsRequest_ItemOfArraySignal_Targeting7482d73a2474263aef0607131830a9ef implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/filters/properties/signal_targeting/items/oneOf/0/properties/signal_id')]
        ...
        protected $signalId;
            ...
            #[JsonPointer('/properties/filters/properties/signal_targeting/items/oneOf/0/properties/value_type')]
        
            #[SchemaName('value_type')]
        
            #[Required]
        
        /** @var string Discriminator for binary signals */
        protected $valueType;
    
        
            #[JsonPointer('/properties/filters/properties/signal_targeting/items/oneOf/0/properties/value')]
        
            #[SchemaName('value')]
        
            #[Required]
        
        /** @var bool Whether to include (true) or exclude (false) users matching this signal */
        protected $value;
    ...
    /**
     * GetProductsRequest_ItemOfArraySignal_Targeting7482d73a2474263aef0607131830a9ef constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsRequest_ItemOfArraySignal_Targeting7482d73a2474263aef0607131830a9ef',
)));
}
...
if (!array_key_exists('signal_id', $modelData)) {
  ...
  0 => 'signal_id',
                    ...
                    $this->validateSignalId_ComposedProperty_d44aaf301201d221f178cc5c79c93232($value, $modelData);
...
private function validateSignalId_ComposedProperty_d44aaf301201d221f178cc5c79c93232(&$value, $modelData): void {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_Signal_Idc051d99d9bca014b860d0fddcd4e1653)) {
  ...
  1 => 'GetProductsRequest_Signal_Idc051d99d9bca014b860d0fddcd4e1653',
                ...
                if (is_object($value) && is_array($originalModelData)) {
                    $modifiedValues = array_merge($modifiedValues, $this->_getModifiedValues_9e2ee($originalModelData, $value));
                }
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_Signal_Idc45bc7f200ab2d9d28f6da1ac702bfc5)) {
  ...
  2 => $compositionErrorCollection,
                        ...
                        private function _getModifiedValues_9e2ee(array $originalModelData, object $nestedCompositionObject): array {
                            $modifiedValues = [];
