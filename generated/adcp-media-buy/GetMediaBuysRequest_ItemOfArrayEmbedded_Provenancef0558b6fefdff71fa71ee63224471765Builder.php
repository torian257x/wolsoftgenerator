...
/**
 * Builder class for GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765
 */
class GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765Builder implements BuilderInterface
{
    /** @var array */
    ...
    /**
     * Set up a new instance of GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765 with fully validated properties
     */
    public function validate(): GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765
    {
        ...
        return new GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765($this->_rawModelDataInput);
    }
    ...
    private function _array_walk_recursive_real(array &$array, callable $callback): void
    {
        foreach ($array as &$value) {
             ...
             *
             * {@link GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765::processMethod}
             * 
             *
             * @return static
             */
             ...
             *
             * {@link GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765::processStandard}
             * 
             *
             * @return static
             */
             ...
             *
             * {@link GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765::processProvider}
             * 
             *
             * @return static
             */
             ...
             *
             * @return GetMediaBuysRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5|GetMediaBuysRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5Builder|array|null
             */
             ...
             *
             * @param GetMediaBuysRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5|GetMediaBuysRequest_Verify_Agent11ee1aca01d22040a3e2f23ff22c68b5Builder|array $verifyAgent Buyer's representation that this embedding can be verified by a governance agent on the seller's `creative_policy.accepted_verifiers` list. The `agent_url` MUST match (canonicalized) one of the seller's published `accepted_verifiers[].agent_url` entries; sellers reject `sync_creatives` submissions whose `verify_agent.agent_url` is off-list with `PROVENANCE_VERIFIER_NOT_ACCEPTED`. This is buyer-supplied evidence, not buyer-driven routing — the seller is the verifier-of-record and the seller controls which agent it actually calls (the seller MAY use a different on-list agent if it determines this is more appropriate; the seller does not call buyer-asserted endpoints outside its allowlist). MAY be omitted for self-verifiable embeddings (e.g., a C2PA text manifest with a public key the seller already trusts).
             *
             * {@link GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765::processVerifyAgent}
             * 
             *
             * @return static
             */
             ...
             *
             * {@link GetMediaBuysRequest_ItemOfArrayEmbedded_Provenancef0558b6fefdff71fa71ee63224471765::processEmbeddedAt}
             * 
             *
             * @return static
             */
