...
/**
 * Class GetProductsRequest_Duration
...
#[JsonPointer('/properties/time_budget/allOf/0')]

class GetProductsRequest_Duration implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/time_budget/allOf/0/properties/interval')]
        ...
        protected $interval;
            ...
            #[JsonPointer('/properties/time_budget/allOf/0/properties/unit')]
        
            #[SchemaName('unit')]
        
            #[Required]
        
        /** @var GetProductsRequest_DurationUnit Time unit. 'seconds' for sub-minute precision. 'campaign' spans the full campaign flight. */
        protected $unit;
    ...
    /**
     * GetProductsRequest_Duration constructor.
     *
...
if (is_int($value) && $value < 1) {
  ...
  1 => 1,
                 ...
                 *
                 * @return GetProductsRequest_DurationUnit
                 */
                public function getUnit(): GetProductsRequest_DurationUnit
                {
                 ...
                 *
                 * @param string|GetProductsRequest_DurationUnit $unit Time unit. 'seconds' for sub-minute precision. 'campaign' spans the full campaign flight.
                 *
                 * @throws ErrorRegistryException
                 *
                 * @return static
                ...
                public function setUnit(
                    string | GetProductsRequest_DurationUnit $unit
                ): static {
                    if ($this->unit === $unit) {
                        return $this;
                    }
...
if ($value instanceof UnitEnum && !($value instanceof GetProductsRequest_DurationUnit)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Generic\InvalidTypeException($value ?? null, ...array (
  0 => 'unit',
  1 => 'GetProductsRequest_DurationUnit',
)));
}
...
(
  ...
  'fqcn' => 'AdCP\\MediaBuy\\Enums\\GetProductsRequest_DurationUnit',
));
