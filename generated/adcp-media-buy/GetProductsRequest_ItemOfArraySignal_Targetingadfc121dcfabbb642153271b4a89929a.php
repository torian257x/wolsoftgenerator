...
/**
 * Class GetProductsRequest_ItemOfArraySignal_Targetingadfc121dcfabbb642153271b4a89929a
 * @package AdCP\MediaBuy 
 *
 * Categorical signal targeting - target users with specific values
 *
...
#[JsonPointer('/properties/filters/properties/signal_targeting/items/oneOf/1')]

class GetProductsRequest_ItemOfArraySignal_Targetingadfc121dcfabbb642153271b4a89929a implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/filters/properties/signal_targeting/items/oneOf/1/properties/signal_id')]
        ...
        protected $signalId;
            ...
            #[JsonPointer('/properties/filters/properties/signal_targeting/items/oneOf/1/properties/value_type')]
        
            #[SchemaName('value_type')]
        
            #[Required]
        
        /** @var string Discriminator for categorical signals */
        protected $valueType;
    
        
            #[JsonPointer('/properties/filters/properties/signal_targeting/items/oneOf/1/properties/values')]
        
            #[SchemaName('values')]
        
            #[Required]
        
        /** @var string[] Values to target. Users with any of these values will be included. */
        protected $values;
    ...
    /**
     * GetProductsRequest_ItemOfArraySignal_Targetingadfc121dcfabbb642153271b4a89929a constructor.
     *
...
if ((function () use ($value) {
  ...
  0 => 'GetProductsRequest_ItemOfArraySignal_Targetingadfc121dcfabbb642153271b4a89929a',
)));
}
...
if ((!is_array($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => 'array',
                    ...
                    $this->validateValues_ArrayItem_36fa26eb5d23970c4726fdfa16aab123($value, $modelData);
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_Signal_Idc051d99d9bca014b860d0fddcd4e1653)) {
  ...
  1 => 'GetProductsRequest_Signal_Idc051d99d9bca014b860d0fddcd4e1653',
                ...
                if (is_object($value) && is_array($originalModelData)) {
                    $modifiedValues = array_merge($modifiedValues, $this->_getModifiedValues_d70cc($originalModelData, $value));
                }
...
private function validateValues_ArrayItem_36fa26eb5d23970c4726fdfa16aab123(&$value, $modelData): void {
...
if ((!is_string($value) && !$value instanceof UnitEnum) ) {
  ...
  1 => $invalidItems_5c553cd2a126a222f1325f20e5aed51f,
                        ...
                        private function _getModifiedValues_d70cc(array $originalModelData, object $nestedCompositionObject): array {
                            $modifiedValues = [];
