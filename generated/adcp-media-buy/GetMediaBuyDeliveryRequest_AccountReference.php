...
/**
 * Class GetMediaBuyDeliveryRequest_AccountReference
...
class GetMediaBuyDeliveryRequest_AccountReference implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;
        ...
        /** @var GetMediaBuyDeliveryRequest_BrandReference|null Brand reference identifying the advertiser */
        protected $brand;
  ...
  2 => 'operator',
    ...
    /**
     * GetMediaBuyDeliveryRequest_AccountReference constructor.
     *
    ...
    public function getRawModelDataInput(): array
    {
        return $this->_rawModelDataInput;
            ...
            protected function validateAccountId($value, array $modelData)
            {
                 ...
                 *
                 * @return GetMediaBuyDeliveryRequest_BrandReference|null
                 */
                public function getBrand(): ?GetMediaBuyDeliveryRequest_BrandReference
                {
                 ...
                 *
                 * @param GetMediaBuyDeliveryRequest_BrandReference|null $brand Brand reference identifying the advertiser
                 *
                 * 
                 *
                 * @return static
                ...
                public function setBrand(
                    ?GetMediaBuyDeliveryRequest_BrandReference $brand
                ): static {
                    if ($this->brand === $brand) {
                        return $this;
                    }
    ...
    try {
        return is_array($value) ? new GetMediaBuyDeliveryRequest_BrandReference($value) : $value;
...
(function (&$value) use (
    ...
    $modifiedValues = [];
        ...
        try {
                ...
                $value = (function ($value) {
    try {
        return is_array($value) ? new GetMediaBuyDeliveryRequest_GetMediaBuyDeliveryRequest_AccountReference391339b2537fe704903ad118e237c1c0($value) : $value;
    } catch (\Exception $instantiationException) {
...
if ((!is_object($value) && !$value instanceof UnitEnum) ) {
  ...
  0 => 'GetMediaBuyDeliveryRequest_AccountReference',
  1 => 'object',
)));
}
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuyDeliveryRequest_GetMediaBuyDeliveryRequest_AccountReference391339b2537fe704903ad118e237c1c0)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'GetMediaBuyDeliveryRequest_AccountReference',
  1 => 'GetMediaBuyDeliveryRequest_GetMediaBuyDeliveryRequest_AccountReference391339b2537fe704903ad118e237c1c0',
)));
}
                ...
                if (is_object($value) && is_array($originalModelData)) {
                    $modifiedValues = array_merge($modifiedValues, $this->_getModifiedValues_0a0e1($originalModelData, $value));
                }
        ...
        try {
                ...
                $value = (function ($value) {
    try {
        return is_array($value) ? new GetMediaBuyDeliveryRequest_GetMediaBuyDeliveryRequest_AccountReference4150dd996f9e6edfbc4269852855249a($value) : $value;
    } catch (\Exception $instantiationException) {
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetMediaBuyDeliveryRequest_GetMediaBuyDeliveryRequest_AccountReference4150dd996f9e6edfbc4269852855249a)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'GetMediaBuyDeliveryRequest_AccountReference',
  1 => 'GetMediaBuyDeliveryRequest_GetMediaBuyDeliveryRequest_AccountReference4150dd996f9e6edfbc4269852855249a',
)));
}
...
public function populate(array $modelData): self
{
    ...
    return $this;
                        ...
                        private function _getModifiedValues_0a0e1(array $originalModelData, object $nestedCompositionObject): array {
                            $modifiedValues = [];
