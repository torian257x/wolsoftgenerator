...
/**
 * Class GetProductsRequest_GetProductsRequest_ItemOfArrayGeo_Proximityb0160231995f80d26603d6288cd1a1db7b0485cc6ae67dccb91bdb62f50ca24f
...
#[JsonPointer('/properties/filters/properties/geo_proximity/items/oneOf/0')]

class GetProductsRequest_GetProductsRequest_ItemOfArrayGeo_Proximityb0160231995f80d26603d6288cd1a1db7b0485cc6ae67dccb91bdb62f50ca24f implements JSONModelInterface, JsonSerializable, SerializationInterface
{
    use SerializableTrait;

    
        
            #[JsonPointer('/properties/filters/properties/geo_proximity/items/oneOf/0/properties/lat')]
        ...
        protected $lat;
            ...
            #[JsonPointer('/properties/filters/properties/geo_proximity/items/oneOf/0/properties/lng')]
        ...
        protected $lng;
            ...
            #[JsonPointer('/properties/filters/properties/geo_proximity/items/oneOf/0/properties/travel_time')]
        ...
        protected $travelTime;
            ...
            #[JsonPointer('/properties/filters/properties/geo_proximity/items/oneOf/0/properties/transport_mode')]
  ...
  array (
    ...
    /**
     * GetProductsRequest_GetProductsRequest_ItemOfArrayGeo_Proximityb0160231995f80d26603d6288cd1a1db7b0485cc6ae67dccb91bdb62f50ca24f constructor.
     *
...
(function (&$value) use (
    ...
    try {
        return is_array($value) ? new GetProductsRequest_GetProductsRequest_GetProductsRequest_ItemOfArrayGeo_Proximityb0160231995f80d26603d6288cd1a1db7b0485cc6ae67dccb91bdb62f50ca24f8230f1fc93dea43e227ba526af977545($value) : $value;
...
if ((!is_object($value) && !$value instanceof UnitEnum) ) {
  ...
  0 => 'GetProductsRequest_GetProductsRequest_ItemOfArrayGeo_Proximityb0160231995f80d26603d6288cd1a1db7b0485cc6ae67dccb91bdb62f50ca24f',
  1 => 'object',
)));
}
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof GetProductsRequest_GetProductsRequest_GetProductsRequest_ItemOfArrayGeo_Proximityb0160231995f80d26603d6288cd1a1db7b0485cc6ae67dccb91bdb62f50ca24f8230f1fc93dea43e227ba526af977545)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'GetProductsRequest_GetProductsRequest_ItemOfArrayGeo_Proximityb0160231995f80d26603d6288cd1a1db7b0485cc6ae67dccb91bdb62f50ca24f',
  1 => 'GetProductsRequest_GetProductsRequest_GetProductsRequest_ItemOfArrayGeo_Proximityb0160231995f80d26603d6288cd1a1db7b0485cc6ae67dccb91bdb62f50ca24f8230f1fc93dea43e227ba526af977545',
)));
}
                ...
                if (is_object($value) && is_array($originalModelData)) {
                    $modifiedValues = array_merge($modifiedValues, $this->_getModifiedValues_86912($originalModelData, $value));
                }
...
public function populate(array $modelData): self
{
    ...
    return $this;
                        ...
                        private function _getModifiedValues_86912(array $originalModelData, object $nestedCompositionObject): array {
                            $modifiedValues = [];
